...
| 7 | 前端框架            | Element                    | https://element.eleme.cn/#/zh-CN/component/quickstart                                                |
...
- - [X] 查询满足条件的所有音乐：`POST /api/categories`
...
- - [X] 收藏音乐：`POST /api/favorites`
- - [X] 取消收藏音乐：`DELETE /api/favorites/{favorite_id}`
- - [X] 获取用户收藏的音乐：`GET /api/favorites/user/{user_id}`
